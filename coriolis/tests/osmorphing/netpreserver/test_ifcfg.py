...
class IfcfgNetPreserverTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test__check_net_preserver_True(self, mock_test_path,
                                       mock_list_dir,
                                       mock_read_config_file):

        mock_test_path.return_value = True
        mock_list_dir.return_value = ["ifcfg-eth0", "ifcfg-eth1"]
        mock_read_config_file.return_value = {"TYPE": "Ethernet",
                                              "DEVICE": "eth0"}
    ...
    @mock.patch.object(base.BaseLinuxOSMorphingTools, '_list_dir')
    @mock.patch.object(base.BaseLinuxOSMorphingTools, '_test_path')
    def test__check_net_preserver_no_ifcfg_files(self, mock_test_path,
                                                 mock_list_dir):
        mock_test_path.return_value = True
    ...
    def test__parse_network(self, mock_get_ifcfgs_by_type):
